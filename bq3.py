...
def findslot3(dt1,dt2,dt3,dt4,dt5,dt6,h,m):
  ...
  if (dtf <= dt2 and dtf <= dt4 and dtf <= dt6):
    res = addtime(tdtf,dtf)
    return res
...
def findslot4(dt1,dt2,dt3,dt4,dt5,dt6,dt7,dt8,h,m):
  ...
  tdtf = dtf
  dtf = dtf+timedelta(hours=h)+timedelta(minutes=m)
  if (dtf <= dt2 and dtf <= dt4 and dtf <= dt6 and dtf <= dt8):
    res = addtime(tdtf,dtf)
    return res
...
def findslot5(dt1,dt2,dt3,dt4,dt5,dt6,dt7,dt8,dt9,dt10,h,m):
  ...
  tdtf = dtf
  dtf = dtf+timedelta(hours=h)+timedelta(minutes=m)
  if (dtf <= dt2 and dtf <= dt4 and dtf <= dt6 and dtf <= dt8 and dtf <= dt10):
    res = addtime(tdtf,dtf)
    return res
...
def findslot(dt1,dt2,dt3,dt4,dt5,dt6,h,m):
  dtf = max(dt1,dt3,dt5)
  tdtf = dtf
  dtf = dtf+timedelta(hours=h)+timedelta(minutes=m)
  if (dtf <= dt2 and dtf <= dt4 and dtf <= dt6):
